...
async function GenerateGeneralHeaders() {
    return [
        ...
        `add_header Content-Security-Policy "default-src 'self' http: https: ws: wss: data: blob: 'unsafe-inline'; frame-ancestors 'self'; script-src 'self' 'unsafe-eval' 'unsafe-inline'" always;`,
